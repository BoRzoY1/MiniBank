...
> **Портфолио для собеседования на позицию Младший программист 1С**
...
- Доступ в интернет (для автоматического обновления курсов валют)

### Установка
1. Склонировать репозиторий:
   ```bash
   git clone https://github.com/BoRzoY1/MiniBank.git
   ```
2. В конфигураторе 1С создать новую пустую информационную базу.
3. В меню конфигуратора выбрать «Конфигурация» → «Загрузить конфигурацию из файлов...».
4. В открывшемся диалоге указать путь к папке 1C_config внутри скачанного репозитория.
5. Нажать «Выполнить» и дождаться окончания загрузки.
6. Обновить конфигурацию базы данных (F7).
7. Запустить 1С:Предприятие. Готово!
